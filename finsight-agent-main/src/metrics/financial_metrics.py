...
class metric_builder:
    ...
    def build_metric_table(
        ...
        # Data cleaning: convert values to numeric, handle missing data, and remove rows with critical missing fields.
        clean_df = combined_df.copy() 
        clean_df["value"] = pd.to_numeric(clean_df["value"], errors="coerce")  
        clean_df = clean_df.dropna(subset=["value", "fy", "fp", "form"]) 
