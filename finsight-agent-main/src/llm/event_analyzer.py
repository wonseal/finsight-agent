...
class EventAnalyzer:
    ...
    def find_best_attribution(
        ...
        # Sort candidates by form priority and take the top_n filings. 
        # This ensures we analyze the most relevant filings first, which is important for both accuracy and efficiency since LLM calls can be costly.
        sorted_candidates = (
            candidates
