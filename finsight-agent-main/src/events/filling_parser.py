...
class FilingParser:
    ...
    def html_to_text(self, html: str) -> str:
        ...
        This is a simplified parser that may not perfectly preserve the structure of the original document, 
        but it should be sufficient for extracting relevant sections based on keyword matching.
        """
        ...
        return "\n".join(non_empty_lines) # join the non-empty lines back into a single string with newlines separating them
